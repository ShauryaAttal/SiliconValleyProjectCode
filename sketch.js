...
var obstacle1Image, obstacle2Image, trackImg;                        //C41// SA
var database, gameState;
var form, player, playerCount;
var allPlayers, car1, car2, fuels, powerCoins, obstacle1, obstacle2, lives; // C41//SA
var cars = [];
...
function preload() {
  ...
  trackImg = loadImage("./assets/track - Copy.jpg");
